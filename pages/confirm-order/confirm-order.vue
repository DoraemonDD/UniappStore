<template>
	<view class='confirm-order bg-active-color'>
		<Lines></Lines>
		<!--地址-->
		<view class='order-map' @tap="toPathList">
			<template v-if='path'>
		...
		<view class='goods-list'>
			<view class='goods-content bg-active-color'>
				<image class='goods-img' mode=""></image>
		...
		<view class='order-foot'>
			<view class='total-price'>合计：<text class='f-active-color'>¥</text></view>
